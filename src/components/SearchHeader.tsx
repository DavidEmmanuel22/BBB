  ...
  return (
    ...
    <View style={{ width:"100%", height: 90, backgroundColor: BLUE, justifyContent:'center', alignItems:'center'}}>
      ...
      <View style={{flexDirection:'row'}}>
        <View style={{ width:"75%"}}>
          <TextInput placeholderTextColor='gray' placeholder='Buscar' style={{borderRadius:200, backgroundColor:'white', color:'black', paddingLeft:36, fontSize:16, height:40}}></TextInput>
